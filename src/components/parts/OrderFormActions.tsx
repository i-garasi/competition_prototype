...
export default function OrderFormActions() {
  return (
    <div className="flex gap-2 border-t pt-4">
      ...
      <FunctionKey label="出荷登録" shortcut="F6" disabled onClick={() => {}} />
      <FunctionKey label="諸口登録" shortcut="F7" onClick={() => {}} />
      <FunctionKey label="複写" shortcut="F8" disabled onClick={() => {}} />
      <FunctionKey label="" shortcut="F9" disabled onClick={() => {}} />
      <FunctionKey label="" shortcut="F10" disabled onClick={() => {}} />
