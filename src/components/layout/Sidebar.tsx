...
const menuItems = [
  {
    ...
    subItems: [
      ...
      { id: 'parts-correction', label: '部品売上修正登録', path: '/parts/correction' },
      { id: 'parts-cancel', label: '部品売注登録', path: '/parts/cancel' },
      { id: 'parts-purchase', label: '部品入庫登録', path: '/parts/purchase' },
      { id: 'parts-transfer', label: '部品受注移動割当登録', path: '/parts/transfer' },
      { id: 'parts-allocation', label: '部品受注移動割当処理', path: '/parts/allocation' },
      { id: 'parts-shipping-inquiry', label: '部品受注出荷照会', path: '/parts/shipping-inquiry' },
      { id: 'parts-inventory-inquiry', label: '部品在庫照会', path: '/parts/inventory-inquiry' },
      { id: 'parts-status', label: '部品受注状況照会', path: '/parts/status' },
      { id: 'parts-transfer-status', label: '部品在庫引当状況照会', path: '/parts/transfer-status' },
      { id: 'parts-repair', label: '部品修送入庫登録', path: '/parts/repair' },
      { id: 'parts-warehouse', label: '部品在庫修正登録', path: '/parts/warehouse' },
      { id: 'parts-return', label: '部品返品登録', path: '/parts/return' },
      { id: 'parts-shipping-instruction', label: '部品特出結果登録', path: '/parts/shipping-instruction' },
    ],
  },
  {
    id: 'products',
